...
if (isset($_POST['daftar'])) {
   //echo 'kesini';
    ...
    $ttlg = $_POST['tanggal_lahir'];
    $q = "INSERT INTO `warga1` (nik, nama, alamat, agama, jenis_kelamin, tanggal_lahir) VALUES ('$nik', '$nama', '$alamat', '$agama', '$jenis_kelamin', '$ttlg')";
                  ...
                  <div class="col-md-6">
                     <form action="" class="main_form" method="post">
                        <div class="row">
                           ...
                           <div class="col-md-12 ">
                              <input class="contactus" placeholder="Masukkan Nama Lengkap" type="text" name="nama" id="nama"> 
                           </div>
                           <div class="col-md-12">
                              <textarea class="textarea" placeholder="Masukkan Alamat" type="text" name="alamat" id="alamat"></textarea>
                           </div>
                           <div class="col-md-12">
                           ...
                           <div class="col-md-12">
                              <select class="contactus" aria-label="Default select example" name="jenis_kelamin" id="jenis_kelamin">
