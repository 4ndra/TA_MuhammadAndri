...
<html lang="en">
    ...
    <?php
        if (isset($_POST['hapus'])) {
            $nik = $_POST['nik'];
            $q = mysqli_query($conn, "DELETE FROM `surat_pengantar` WHERE nik = '$nik'");
        }
    ?>
        <meta charset="utf-8" />
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <a class="nav-link" href="../../dashboard.php">
                            ...
                            <a class="nav-link" href="../surat_pengantar/index.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table border="1" cellspacing="0" class="table">
                                    ...
                                    <?php
                                    $no = 1;
                                    $pengantar = mysqli_query($conn, "SELECT * FROM `surat_pengantar` ORDER BY nik DESC");
                                        while($row = mysqli_fetch_array($pengantar)){
        ...
        <script src="js/startbootstrap-sb-admin-gh-pages/js/scripts.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
        <script src="js/startbootstrap-sb-admin-gh-pages/js/datatables-simple-demo.js"></script>
    </body>
</html>
