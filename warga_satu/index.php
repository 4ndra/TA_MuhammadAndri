                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table border="1" cellspacing="0" class="table">
                                    ...
                                    <?php
                                    $no = 1;
                                    $warga = mysqli_query($conn, "SELECT * FROM `warga1` ORDER BY nik DESC");
                                ...
                                <tr>
                                    ...
                                    <td>
                                                <form action="" method="post"><input type="hidden" name="nik" value="<?= $nik ?>"><button name="hapus" class="btn btn-danger"><i class="fa fa-trash"></i></button></form>
                                            </td>
                                </tr>
                                <?php } ?>
